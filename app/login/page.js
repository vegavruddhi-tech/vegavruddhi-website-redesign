    ...
    <div className="min-h-screen bg-slate-50/50 relative overflow-hidden font-sans">
      ...
      <main className="pt-32 pb-24 container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          {/* Header Branding */}
          <div className="lg:w-1/3 space-y-10 animate-fade-in-up">
            ...
            <div className="p-8 rounded-3xl bg-white border border-gray-100 shadow-sm group hover:shadow-xl transition-all duration-500">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-900 leading-tight">Identity & Access Management</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Portal Options */}
          <div className="lg:w-2/3 grid gap-5 animate-fade-in-up delay-150">
            {portals.map((portal, index) => (
              ...
              >
                <div className="relative overflow-hidden bg-white/70 backdrop-blur-md p-7 md:p-9 rounded-[2rem] border border-gray-100 hover:border-primary/20 transition-all duration-500 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)]">
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-7 relative z-10">
                    <div className="w-20 h-20 bg-slate-50 text-gray-400 group-hover:bg-primary group-hover:text-white rounded-2xl flex items-center justify-center transition-all duration-500 transform group-hover:scale-105 shadow-inner">
                      {portal.icon}
                    </div>

                    <div className="flex-grow text-center md:text-left space-y-3">
                      <div className="flex flex-col md:flex-row md:items-baseline gap-2 md:gap-4">
                        <h2 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight group-hover:text-primary transition-colors">{portal.title}</h2>
                        <span className="text-[10px] font-black text-primary/60 uppercase tracking-widest">{portal.short}</span>
                      </div>
                      <p className="text-gray-400 font-medium text-sm md:text-base leading-relaxed max-w-lg">
                        {portal.description}
                      </p>
                      <div className="pt-2">
                        <span className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 group-hover:bg-primary group-hover:text-white rounded-lg text-[10px] font-black uppercase tracking-widest transition-all duration-300">
                          Click Here
